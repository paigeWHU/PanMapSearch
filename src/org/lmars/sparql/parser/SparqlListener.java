...
public interface SparqlListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link SparqlParser#functionList}.
	 * @param ctx the parse tree
	 */
	void enterFunctionList(@NotNull SparqlParser.FunctionListContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparqlParser#functionList}.
	 * @param ctx the parse tree
	 */
	void exitFunctionList(@NotNull SparqlParser.FunctionListContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SparqlParser#paramDeclList}.
	 * @param ctx the parse tree
	 */
	void enterParamDeclList(@NotNull SparqlParser.ParamDeclListContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparqlParser#paramDeclList}.
	 * @param ctx the parse tree
	 */
	void exitParamDeclList(@NotNull SparqlParser.ParamDeclListContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link SparqlParser#function}.
	 * @param ctx the parse tree
	 */
	void enterFunction(@NotNull SparqlParser.FunctionContext ctx);
	/**
	 * Exit a parse tree produced by {@link SparqlParser#function}.
	 * @param ctx the parse tree
	 */
	void exitFunction(@NotNull SparqlParser.FunctionContext ctx);
	/**
