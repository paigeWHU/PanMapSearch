...
//		boolean temp1 = spatialCompute.judge("18", "31");
//		System.out.print(temp1);
//		ArrayList<String> result = spatialCompute.compute("18");
////		 ArrayList<String> result = test.OppositeRoomID("18");
//		 for (int i = 0; i < result.size(); i++) {
//			System.out.print(result.get(i)+",");
//		}
		 
	        String temp = "<http://www.semanticweb.org/dell327/ontologies/2014/10/Ontology1415628375607.owl#205>";

//	        System.out.print(test.IriToID(temp));
	        //	
...
////		
////				
//		Geometry geometry =  spatialSelect.GetGeometry("15");
...
//			System.out.print(String.valueOf(geoPolygons.geoPolygons.get(0).polygonRings.get(0).numPoints));	
//		default:
//			break;
//		}
